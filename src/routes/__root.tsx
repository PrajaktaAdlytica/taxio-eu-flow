...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Taxio Flow automates European VAT compliance, e-invoicing, and evidence management for SMEs." },
      { property: "og:description", content: "Taxio Flow automates European VAT compliance, e-invoicing, and evidence management for SMEs." },
      { name: "twitter:description", content: "Taxio Flow automates European VAT compliance, e-invoicing, and evidence management for SMEs." },
