...
export const Route = createFileRoute("/signin")({
  head: () => ({
    meta: [
      { title: "Sign In — Taxio" },
      { name: "description", content: "Sign in to your Taxio workspace." },
    ],
  }),
  component: SignIn,
});
      ...
      <div className="relative hidden lg:flex flex-col bg-primary text-primary-foreground p-10 overflow-hidden">
        ...
        <div className="relative mt-auto max-w-md">
          <h2 className="text-4xl font-semibold tracking-tight text-balance leading-[1.05]">
            Sign in to your <span className="font-editorial text-accent">Taxio</span> workspace.
          </h2>
          <p className="mt-4 text-sm text-primary-foreground/70">
            European VAT compliance, e-invoicing and evidence — unified in one intelligent platform.
          </p>
          <div className="mt-8 flex items-center gap-2 text-xs text-primary-foreground/60">
            <span className="h-1 w-1 rounded-full bg-accent" /> EU-hosted · GDPR compliant · 27 countries
          </div>
        </div>
      </div>
